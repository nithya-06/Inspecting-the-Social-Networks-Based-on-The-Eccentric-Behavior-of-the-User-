<%-- 
    Document   : detailsAboutU
    Created on : Nov 3, 2015, 12:55:25 AM
    Author     : ArunRamya
--%>
                    ...
                    <div class="column col-sm-10 col-xs-11" id="main">
                        ...
                        <div class="padding">
                            <div class="full col-sm-9">
                                <center>
                                    <form method="post" action="DetailsAbtUServlet">
                                        <div><h4>Details about you</h4></div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label"></label>
                                            <div class="col-sm-9">
                                                <textarea name="about_you" placeholder="About you" class="form-control" rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label"></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="nickname" class="form-control" id="inputEmail3" placeholder="Nick Name" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label"></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="fav" class="form-control" id="inputEmail3" placeholder="Favourites" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
