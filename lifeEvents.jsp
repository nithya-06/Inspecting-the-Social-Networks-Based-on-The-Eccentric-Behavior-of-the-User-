<%-- 
    Document   : lifeEvents
    Created on : Nov 3, 2015, 1:07:32 AM
    Author     : ArunRamya
--%>
                            ...
                            <div class="full col-sm-9">
                                <center>
                                    <form method="post" action="">
                                        <div><h4>Memorable Life events</h4></div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">DOB</label>
                                            <div class="col-sm-9">
                                                <input type="date" name="anniversary" class="form-control" value="dd-MM-yyyy">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label"></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="events" class="form-control" id="inputEmail3" placeholder="Important events" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
